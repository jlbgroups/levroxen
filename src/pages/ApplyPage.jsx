...
const ApplyPage = () => {
    ...
    return ( <
        ...
        p className = "apply-desc" > Fill out the details below.This will generate an email to our HR team(hiring @levroxen.com) with your application details. < /p> < /
        div >
        ...
        onChange = { handleChange }
        required placeholder = "https://drive.google.com/file/..." / >
        <
        /div>
        ...
        Note: Clicking submit will open your email client with the details pre - filled to send to < strong > hiring @levroxen.com < /strong>. < /
        p > <
        /form> < /
        div > <
        /div> < /
